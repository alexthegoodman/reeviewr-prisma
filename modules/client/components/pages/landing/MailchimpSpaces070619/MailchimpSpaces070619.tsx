...
import { MailchimpSpaces070619Props } from "./MailchimpSpaces070619.d";

const MailchimpSpaces070619: React.FC<MailchimpSpaces070619Props> = () => {
  return (
    <main>
      <LandingHeroA>
...
export default MailchimpSpaces070619;
