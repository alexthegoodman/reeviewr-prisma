# Migration `20191008091252-init`

This migration has been generated by Alex Woodman at 10/8/2019, 9:12:52 AM.
...
You can use a specific Photon built for this migration (20191008091252-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191008091252-init'
