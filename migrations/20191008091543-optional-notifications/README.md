# Migration `20191008091543-optional-notifications`

This migration has been generated by Alex Woodman at 10/8/2019, 9:15:43 AM.
...
migration 20191008091252-init..20191008091543-optional-notifications
--- datamodel.dml
+++ datamodel.dml
@@ -34,10 +34,10 @@
   threads               Thread[]
...
You can use a specific Photon built for this migration (20191008091543-optional-notifications)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191008091543-optional-notifications'
