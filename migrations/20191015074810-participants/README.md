# Migration `20191015074810-participants`

This migration has been generated by Alex Woodman at 10/15/2019, 7:48:10 AM.
You can check out the [state of the datamodel](./datamodel.prisma) after the migration.

## Database Steps

```sql
CREATE TABLE "public"."_ThreadToUser"("A" text   REFERENCES "public"."Thread"("id") ON DELETE CASCADE,"B" text   REFERENCES "public"."User"("id") ON DELETE CASCADE);
...
ALTER TABLE "public"."Thread" DROP COLUMN "user";
...
ALTER TABLE "public"."Notification" DROP COLUMN "sender",ADD COLUMN "sender" text   REFERENCES "public"."User"("id") ON DELETE SET NULL,DROP COLUMN "receiver",ADD COLUMN "receiver" text   REFERENCES "public"."User"("id") ON DELETE SET NULL;
...
migration 20191009081017-init..20191015074810-participants
--- datamodel.dml
+++ datamodel.dml
@@ -195,17 +195,17 @@
 }
...
You can use a specific Photon built for this migration (20191015074810-participants)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191015074810-participants'
