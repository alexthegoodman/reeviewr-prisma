...
export declare class PrismaClient<T extends PrismaClientOptions = {}, U = keyof T extends 'log' ? T['log'] extends Array<LogLevel | LogDefinition> ? GetEvents<T['log']> : never : never> {
  ...
  */
   ...
   * `prisma.space`: Exposes CRUD operations for the **Space** model.
    ...
    * ```
    */
  get space(): SpaceDelegate;

  /**
   * `prisma.spaceMeta`: Exposes CRUD operations for the **SpaceMeta** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more SpaceMetas
    * const spaceMetas = await prisma.spaceMeta.findMany()
    * ```
    */
  get spaceMeta(): SpaceMetaDelegate;
...
export type UserSelect = {
  ...
  spaces?: boolean | FindManySpaceArgs
  memberOf?: boolean | FindManySpaceArgs
  ...
  sentNotifications?: boolean | FindManyNotificationArgs
  recievedNotifications?: boolean | FindManyNotificationArgs
  createdAt?: boolean
  updatedAt?: boolean
...
> = S extends true
  ...
  ? 'include' extends U
    ? User  & {
      ...
      P extends 'spaces'
      ? Array<SpaceGetPayload<S['include'][P]>> :
      P extends 'memberOf'
      ? Array<SpaceGetPayload<S['include'][P]>> :
      P extends 'favorites'
...
: 
      ...
      P extends 'spaces'
      ? Array<SpaceGetPayload<S['select'][P]>> :
      P extends 'memberOf'
      ? Array<SpaceGetPayload<S['select'][P]>> :
      P extends 'favorites'
...
export declare class UserClient<T> implements Promise<T> {
  ...
  spaces<T extends FindManySpaceArgs = {}>(args?: Subset<T, FindManySpaceArgs>): CheckSelect<T, Promise<Array<Space>>, Promise<Array<SpaceGetPayload<T>>>>;

  memberOf<T extends FindManySpaceArgs = {}>(args?: Subset<T, FindManySpaceArgs>): CheckSelect<T, Promise<Array<Space>>, Promise<Array<SpaceGetPayload<T>>>>;
  ...
  sentNotifications<T extends FindManyNotificationArgs = {}>(args?: Subset<T, FindManyNotificationArgs>): CheckSelect<T, Promise<Array<Notification>>, Promise<Array<NotificationGetPayload<T>>>>;

  recievedNotifications<T extends FindManyNotificationArgs = {}>(args?: Subset<T, FindManyNotificationArgs>): CheckSelect<T, Promise<Array<Notification>>, Promise<Array<NotificationGetPayload<T>>>>;
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends UserMetaArgs | FindManyUserMetaArgs
  ? 'include' extends U
    ? UserMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'user'
...
export interface UserMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyUserMetaArgs, 'select' | 'include'>): Promise<number>
}
...
export type SpaceSelect = {
  ...
  itemContent?: boolean
  itemDeleted?: boolean
  itemMeta?: boolean | FindManySpaceMetaArgs
  posts?: boolean | FindManyPostArgs
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends SpaceArgs | FindManySpaceArgs
  ? 'include' extends U
    ? Space  & {
      [P in TrueKeys<S['include']>]:
      P extends 'user'
      ...
      ? Array<UserGetPayload<S['include'][P]>> :
      P extends 'itemMeta'
      ? Array<SpaceMetaGetPayload<S['include'][P]>> :
      P extends 'posts'
      ? Array<PostGetPayload<S['include'][P]>> :
  ...
  : 'select' extends U
    ? {
      [P in TrueKeys<S['select']>]:P extends keyof Space ? Space[P]
: 
      P extends 'user'
      ...
      ? Array<UserGetPayload<S['select'][P]>> :
      P extends 'itemMeta'
      ? Array<SpaceMetaGetPayload<S['select'][P]>> :
      P extends 'posts'
      ? Array<PostGetPayload<S['select'][P]>> :
      P extends 'categories'
...
export interface SpaceDelegate {
   ...
   * @param {FindOneSpaceArgs} args - Arguments to find a Space
   * @example
   * // Get one Space
   * const space = await prisma.space.findOne({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  **/
  findOne<T extends FindOneSpaceArgs>(
    args: Subset<T, FindOneSpaceArgs>
  ): CheckSelect<T, SpaceClient<Space | null>, SpaceClient<SpaceGetPayload<T> | null>>
  /**
   * Find zero or more Spaces.
   * @param {FindManySpaceArgs=} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all Spaces
   * const spaces = await prisma.space.findMany()
   * 
   * // Get first 10 Spaces
   * const spaces = await prisma.space.findMany({ first: 10 })
   * 
   * // Only select the `id`
   * const spaceWithIdOnly = await prisma.space.findMany({ select: { id: true } })
   * 
  **/
  findMany<T extends FindManySpaceArgs>(
    args?: Subset<T, FindManySpaceArgs>
  ): CheckSelect<T, Promise<Array<Space>>, Promise<Array<SpaceGetPayload<T>>>>
  /**
   * Create a Space.
   * @param {SpaceCreateArgs} args - Arguments to create a Space.
   * @example
   * // Create one Space
   * const user = await prisma.space.create({
   *   data: {
  ...
  **/
  create<T extends SpaceCreateArgs>(
    args: Subset<T, SpaceCreateArgs>
  ): CheckSelect<T, SpaceClient<Space>, SpaceClient<SpaceGetPayload<T>>>
  /**
   * Delete a Space.
   * @param {SpaceDeleteArgs} args - Arguments to delete one Space.
   * @example
   * // Delete one Space
   * const user = await prisma.space.delete({
   *   where: {
  ...
  **/
  deleteMany<T extends SpaceDeleteManyArgs>(
    args: Subset<T, SpaceDeleteManyArgs>
  ): Promise<BatchPayload>
  /**
  ...
  **/
  updateMany<T extends SpaceUpdateManyArgs>(
    args: Subset<T, SpaceUpdateManyArgs>
  ): Promise<BatchPayload>
  /**
  ...
  **/
  upsert<T extends SpaceUpsertArgs>(
    args: Subset<T, SpaceUpsertArgs>
  ): CheckSelect<T, SpaceClient<Space>, SpaceClient<SpaceGetPayload<T>>>
  /**
   * 
   */
  count(args?: Omit<FindManySpaceArgs, 'select' | 'include'>): Promise<number>
}

export declare class SpaceClient<T> implements Promise<T> {
  private readonly _dmmf;
  private readonly _fetcher;
  private readonly _queryType;
  private readonly _rootField;
  ...
  itemMeta<T extends FindManySpaceMetaArgs = {}>(args?: Subset<T, FindManySpaceMetaArgs>): CheckSelect<T, Promise<Array<SpaceMeta>>, Promise<Array<SpaceMetaGetPayload<T>>>>;
...
export type FindManySpaceArgs = {
  ...
  **/
  ...
  /**
   * Determine the order of the Spaces to fetch.
  **/
  orderBy?: SpaceOrderByInput | null
  /**
   * Skip the first `n` Spaces.
  **/
  skip?: number | null
  /**
   * Get all Spaces that come after the Space you provide with the current order.
  **/
  after?: SpaceWhereUniqueInput | null
  /**
   * Get all Spaces that come before the Space you provide with the current order.
  **/
  before?: SpaceWhereUniqueInput | null
  /**
   * Get the first `n` Spaces.
  **/
  first?: number | null
  /**
   * Get the last `n` Spaces.
  **/
  last?: number | null
}
...
export type SpaceMetaInclude = {
  space?: boolean | SpaceArgs
}

export type SpaceMetaGetPayload<
  S extends boolean | null | undefined | SpaceMetaArgs,
  U = keyof S
> = S extends true
  ? SpaceMeta
  : S extends undefined
  ? never
  : S extends SpaceMetaArgs | FindManySpaceMetaArgs
  ? 'include' extends U
    ? SpaceMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'space'
      ? SpaceGetPayload<S['include'][P]> : never
    }
  : 'select' extends U
    ? {
      [P in TrueKeys<S['select']>]:P extends keyof SpaceMeta ? SpaceMeta[P]
: 
      P extends 'space'
      ? SpaceGetPayload<S['select'][P]> : never
    }
  : SpaceMeta
: SpaceMeta


export interface SpaceMetaDelegate {
  /**
   * Find zero or one SpaceMeta.
   * @param {FindOneSpaceMetaArgs} args - Arguments to find a SpaceMeta
   * @example
   * // Get one SpaceMeta
   * const spaceMeta = await prisma.spaceMeta.findOne({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  **/
  findOne<T extends FindOneSpaceMetaArgs>(
    args: Subset<T, FindOneSpaceMetaArgs>
  ): CheckSelect<T, SpaceMetaClient<SpaceMeta | null>, SpaceMetaClient<SpaceMetaGetPayload<T> | null>>
  /**
   * Find zero or more SpaceMetas.
   * @param {FindManySpaceMetaArgs=} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all SpaceMetas
   * const spaceMetas = await prisma.spaceMeta.findMany()
   * 
   * // Get first 10 SpaceMetas
   * const spaceMetas = await prisma.spaceMeta.findMany({ first: 10 })
   * 
   * // Only select the `id`
   * const spaceMetaWithIdOnly = await prisma.spaceMeta.findMany({ select: { id: true } })
   * 
  **/
  findMany<T extends FindManySpaceMetaArgs>(
    args?: Subset<T, FindManySpaceMetaArgs>
  ): CheckSelect<T, Promise<Array<SpaceMeta>>, Promise<Array<SpaceMetaGetPayload<T>>>>
  /**
   * Create a SpaceMeta.
   * @param {SpaceMetaCreateArgs} args - Arguments to create a SpaceMeta.
   * @example
   * // Create one SpaceMeta
   * const user = await prisma.spaceMeta.create({
   *   data: {
   *     // ... data to create a SpaceMeta
   *   }
   * })
   * 
  **/
  create<T extends SpaceMetaCreateArgs>(
    args: Subset<T, SpaceMetaCreateArgs>
  ): CheckSelect<T, SpaceMetaClient<SpaceMeta>, SpaceMetaClient<SpaceMetaGetPayload<T>>>
  /**
   * Delete a SpaceMeta.
   * @param {SpaceMetaDeleteArgs} args - Arguments to delete one SpaceMeta.
   * @example
   * // Delete one SpaceMeta
   * const user = await prisma.spaceMeta.delete({
   *   where: {
   *     // ... filter to delete one SpaceMeta
   *   }
   * })
   * 
  **/
  delete<T extends SpaceMetaDeleteArgs>(
    args: Subset<T, SpaceMetaDeleteArgs>
  ): CheckSelect<T, SpaceMetaClient<SpaceMeta>, SpaceMetaClient<SpaceMetaGetPayload<T>>>
  /**
   * Update one SpaceMeta.
   * @param {SpaceMetaUpdateArgs} args - Arguments to update one SpaceMeta.
   * @example
   * // Update one SpaceMeta
   * const spaceMeta = await prisma.spaceMeta.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
   ...
   * 
  **/
  update<T extends SpaceMetaUpdateArgs>(
    args: Subset<T, SpaceMetaUpdateArgs>
  ): CheckSelect<T, SpaceMetaClient<SpaceMeta>, SpaceMetaClient<SpaceMetaGetPayload<T>>>
  /**
   * Delete zero or more SpaceMetas.
   * @param {SpaceMetaDeleteManyArgs} args - Arguments to filter SpaceMetas to delete.
   * @example
   * // Delete a few SpaceMetas
   * const { count } = await prisma.spaceMeta.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
   * 
  **/
  deleteMany<T extends SpaceMetaDeleteManyArgs>(
    args: Subset<T, SpaceMetaDeleteManyArgs>
  ): Promise<BatchPayload>
  /**
   * Update zero or more SpaceMetas.
   * @param {SpaceMetaUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many SpaceMetas
   * const spaceMeta = await prisma.spaceMeta.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
   ...
   * 
  **/
  updateMany<T extends SpaceMetaUpdateManyArgs>(
    args: Subset<T, SpaceMetaUpdateManyArgs>
  ): Promise<BatchPayload>
  /**
   * Create or update one SpaceMeta.
   * @param {SpaceMetaUpsertArgs} args - Arguments to update or create a SpaceMeta.
   * @example
   * // Update or create a SpaceMeta
   * const spaceMeta = await prisma.spaceMeta.upsert({
   *   create: {
   *     // ... data to create a SpaceMeta
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the SpaceMeta we want to update
   *   }
   * })
  **/
  upsert<T extends SpaceMetaUpsertArgs>(
    args: Subset<T, SpaceMetaUpsertArgs>
  ): CheckSelect<T, SpaceMetaClient<SpaceMeta>, SpaceMetaClient<SpaceMetaGetPayload<T>>>
  /**
   * 
   */
  count(args?: Omit<FindManySpaceMetaArgs, 'select' | 'include'>): Promise<number>
}

export declare class SpaceMetaClient<T> implements Promise<T> {
  private readonly _dmmf;
  private readonly _fetcher;
  private readonly _queryType;
  private readonly _rootField;
  ...
  space<T extends SpaceArgs = {}>(args?: Subset<T, SpaceArgs>): CheckSelect<T, SpaceClient<Space | null>, SpaceClient<SpaceGetPayload<T> | null>>;
 ...
 * SpaceMeta findOne
 */
export type FindOneSpaceMetaArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
  /**
   * Choose, which related nodes to fetch as well.
  **/
  include?: SpaceMetaInclude | null
  /**
   * Filter, which SpaceMeta to fetch.
  **/
 ...
 * SpaceMeta findMany
 */
export type FindManySpaceMetaArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
  ...
  **/
  include?: SpaceMetaInclude | null
  /**
   * Filter, which SpaceMetas to fetch.
  **/
  where?: SpaceMetaWhereInput | null
  /**
   * Determine the order of the SpaceMetas to fetch.
  **/
  orderBy?: SpaceMetaOrderByInput | null
  /**
   * Skip the first `n` SpaceMetas.
  **/
  skip?: number | null
  /**
   * Get all SpaceMetas that come after the SpaceMeta you provide with the current order.
  **/
  after?: SpaceMetaWhereUniqueInput | null
  /**
   * Get all SpaceMetas that come before the SpaceMeta you provide with the current order.
  **/
  before?: SpaceMetaWhereUniqueInput | null
  /**
   * Get the first `n` SpaceMetas.
  **/
  first?: number | null
  /**
   * Get the last `n` SpaceMetas.
  **/
  last?: number | null
}
 ...
 * SpaceMeta create
 */
export type SpaceMetaCreateArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
  ...
  **/
  include?: SpaceMetaInclude | null
  /**
   * The data needed to create a SpaceMeta.
  **/
  data: SpaceMetaCreateInput
}
 ...
 * SpaceMeta update
 */
export type SpaceMetaUpdateArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
  ...
  **/
  include?: SpaceMetaInclude | null
  /**
   * The data needed to update a SpaceMeta.
  **/
  data: SpaceMetaUpdateInput
  /**
   * Choose, which SpaceMeta to update.
  **/
  where: SpaceMetaWhereUniqueInput
}
...
/**
 * SpaceMeta updateMany
 */
export type SpaceMetaUpdateManyArgs = {
  data: SpaceMetaUpdateManyMutationInput
  where?: SpaceMetaWhereInput | null
}
 ...
 * SpaceMeta upsert
 */
export type SpaceMetaUpsertArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
  ...
  **/
  include?: SpaceMetaInclude | null
  /**
   * The filter to search for the SpaceMeta to update in case it exists.
  **/
  where: SpaceMetaWhereUniqueInput
  /**
   * In case the SpaceMeta found by the `where` argument doesn't exist, create a new SpaceMeta with this data.
  **/
  create: SpaceMetaCreateInput
  /**
   * In case the SpaceMeta was found with the provided `where` argument, update it with this data.
  **/
  update: SpaceMetaUpdateInput
}
 ...
 * SpaceMeta delete
 */
export type SpaceMetaDeleteArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
  ...
  **/
  include?: SpaceMetaInclude | null
  /**
   * Filter which SpaceMeta to delete.
  **/
  where: SpaceMetaWhereUniqueInput
}
...
/**
 * SpaceMeta deleteMany
 */
export type SpaceMetaDeleteManyArgs = {
  where?: SpaceMetaWhereInput | null
}


/**
 * SpaceMeta without action
 */
export type SpaceMetaArgs = {
  /**
   * Select specific fields to fetch from the SpaceMeta
  **/
  select?: SpaceMetaSelect | null
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends PostMetaArgs | FindManyPostMetaArgs
  ? 'include' extends U
    ? PostMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'post'
...
export interface PostMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyPostMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends ReviewMetaArgs | FindManyReviewMetaArgs
  ? 'include' extends U
    ? ReviewMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'review'
...
export interface ReviewMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyReviewMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends AnnotationArgs | FindManyAnnotationArgs
  ? 'include' extends U
    ? Annotation  & {
      [P in TrueKeys<S['include']>]:
      P extends 'user'
...
export interface AnnotationDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyAnnotationArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends AnnotationMetaArgs | FindManyAnnotationMetaArgs
  ? 'include' extends U
    ? AnnotationMeta  & {
      [P in TrueKeys<S['include']>]:
...
export interface AnnotationMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyAnnotationMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends QuestionMetaArgs | FindManyQuestionMetaArgs
  ? 'include' extends U
    ? QuestionMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'question'
...
export interface QuestionMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyQuestionMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends ThreadArgs | FindManyThreadArgs
  ? 'include' extends U
    ? Thread  & {
      [P in TrueKeys<S['include']>]:
      P extends 'itemMeta'
...
export interface ThreadDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyThreadArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends ThreadMetaArgs | FindManyThreadMetaArgs
  ? 'include' extends U
    ? ThreadMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'thread'
...
export interface ThreadMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyThreadMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends MessageMetaArgs | FindManyMessageMetaArgs
  ? 'include' extends U
    ? MessageMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'message'
...
export interface MessageMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyMessageMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends NotificationMetaArgs | FindManyNotificationMetaArgs
  ? 'include' extends U
    ? NotificationMeta  & {
      [P in TrueKeys<S['include']>]:
      P extends 'notification'
...
export interface NotificationMetaDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyNotificationMetaArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  : S extends undefined
  ? never
  : S extends FavoriteArgs | FindManyFavoriteArgs
  ? 'include' extends U
    ? Favorite  & {
      [P in TrueKeys<S['include']>]:
      P extends 'user'
...
export interface FavoriteDelegate {
  ...
  **/
   ...
   * 
   */
  count(args?: Omit<FindManyFavoriteArgs, 'select' | 'include'>): Promise<number>
}
...
> = S extends true
  ...
  ? 'include' extends U
    ? Category  & {
      [P in TrueKeys<S['include']>]:
      P extends 'spaces'
      ? Array<SpaceGetPayload<S['include'][P]>> : never
    }
  : 'select' extends U
    ? {
...
: 
      P extends 'spaces'
      ? Array<SpaceGetPayload<S['select'][P]>> : never
    }
  : Category
: Category
...
export type SpaceMetaWhereInput = {
  id?: string | StringFilter | null
  spaceId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
  createdAt?: Date | string | DateTimeFilter | null
  updatedAt?: Date | string | DateTimeFilter | null
  AND?: Enumerable<SpaceMetaWhereInput> | null
  OR?: Enumerable<SpaceMetaWhereInput> | null
  NOT?: Enumerable<SpaceMetaWhereInput> | null
...
export type NotificationMetaWhereInput = {
  id?: string | StringFilter | null
  notificationId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
...
export type NotificationWhereInput = {
  ...
  senderId?: string | StringFilter | null
  receiverId?: string | StringFilter | null
  spaceId?: string | StringFilter | null
  postId?: string | StringFilter | null
  createdAt?: Date | string | DateTimeFilter | null
  updatedAt?: Date | string | DateTimeFilter | null
...
export type SpaceWhereInput = {
  ...
  itemContent?: string | StringFilter | null
  itemDeleted?: boolean | BooleanFilter | null
  itemMeta?: SpaceMetaFilter | null
  posts?: PostFilter | null
  categories?: CategoryFilter | null
  createdAt?: Date | string | DateTimeFilter | null
  updatedAt?: Date | string | DateTimeFilter | null
  Notification?: NotificationFilter | null
  AND?: Enumerable<SpaceWhereInput> | null
  OR?: Enumerable<SpaceWhereInput> | null
  NOT?: Enumerable<SpaceWhereInput> | null
  user?: UserWhereInput | null
}
...
export type ReviewMetaWhereInput = {
  id?: string | StringFilter | null
  reviewId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
...
export type AnnotationMetaWhereInput = {
  id?: string | StringFilter | null
  annotationId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
...
export type QuestionMetaWhereInput = {
  id?: string | StringFilter | null
  questionId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
...
export type ThreadMetaWhereInput = {
  id?: string | StringFilter | null
  threadId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
...
export type MessageMetaWhereInput = {
  id?: string | StringFilter | null
  messageId?: string | StringFilter | null
  metaType?: string | StringFilter | null
  metaName?: string | StringFilter | null
  metaValue?: string | StringFilter | null
  metaDeleted?: boolean | BooleanFilter | null
...
export type UserWhereInput = {
  ...
  sentNotifications?: NotificationFilter | null
  recievedNotifications?: NotificationFilter | null
  createdAt?: Date | string | DateTimeFilter | null
  updatedAt?: Date | string | DateTimeFilter | null
...
export type SpaceMetaCreateManyWithoutSpaceInput = {
  create?: Enumerable<SpaceMetaCreateWithoutSpaceInput> | null
  connect?: Enumerable<SpaceMetaWhereUniqueInput> | null
}
...
export type CategoryCreateManyWithoutSpacesInput = {
  create?: Enumerable<CategoryCreateWithoutSpacesInput> | null
...
export type SpaceCreateWithoutNotificationInput = {
  ...
  itemMeta?: SpaceMetaCreateManyWithoutSpaceInput | null
  posts?: PostCreateManyWithoutSpaceInput | null
  categories?: CategoryCreateManyWithoutSpacesInput | null
}

export type SpaceCreateOneWithoutNotificationInput = {
  create?: SpaceCreateWithoutNotificationInput | null
  connect?: SpaceWhereUniqueInput | null
}
...
export type UserCreateWithoutThreadsInput = {
  ...
  spaces?: SpaceCreateManyWithoutUserInput | null
  memberOf?: SpaceCreateManyWithoutMembersInput | null
  ...
  sentNotifications?: NotificationCreateManyWithoutSenderInput | null
  recievedNotifications?: NotificationCreateManyWithoutReceiverInput | null
  Message?: MessageCreateManyWithoutUserInput | null
}
...
export type NotificationCreateManyWithoutReceiverInput = {
  create?: Enumerable<NotificationCreateWithoutReceiverInput> | null
...
export type PostCreateOneWithoutNotificationInput = {
  create?: PostCreateWithoutNotificationInput | null
...
export type NotificationCreateManyWithoutSenderInput = {
  create?: Enumerable<NotificationCreateWithoutSenderInput> | null
  connect?: Enumerable<NotificationWhereUniqueInput> | null
}
...
export type PostCreateWithoutQuestionsInput = {
  ...
  reviews?: ReviewCreateManyWithoutPostInput | null
  annotations?: AnnotationCreateManyWithoutPostInput | null
  Notification?: NotificationCreateManyWithoutPostInput | null
}
...
export type NotificationCreateManyWithoutSpaceInput = {
  create?: Enumerable<NotificationCreateWithoutSpaceInput> | null
  connect?: Enumerable<NotificationWhereUniqueInput> | null
}
...
export type SpaceCreateWithoutUserInput = {
  ...
  posts?: PostCreateManyWithoutSpaceInput | null
  categories?: CategoryCreateManyWithoutSpacesInput | null
  Notification?: NotificationCreateManyWithoutSpaceInput | null
}

export type SpaceCreateManyWithoutUserInput = {
  create?: Enumerable<SpaceCreateWithoutUserInput> | null
  connect?: Enumerable<SpaceWhereUniqueInput> | null
}
...
export type PostCreateManyWithoutSpaceInput = {
  create?: Enumerable<PostCreateWithoutSpaceInput> | null
...
export type SpaceCreateManyWithoutMembersInput = {
  create?: Enumerable<SpaceCreateWithoutMembersInput> | null
  connect?: Enumerable<SpaceWhereUniqueInput> | null
}
...
export type UserCreateOneWithoutSpacesInput = {
  create?: UserCreateWithoutSpacesInput | null
  connect?: UserWhereUniqueInput | null
}
...
export type SpaceCreateOneWithoutPostsInput = {
  create?: SpaceCreateWithoutPostsInput | null
  connect?: SpaceWhereUniqueInput | null
}
...
export type SpaceMetaScalarWhereInput = {
  ...
  createdAt?: Date | string | DateTimeFilter | null
  updatedAt?: Date | string | DateTimeFilter | null
  AND?: Enumerable<SpaceMetaScalarWhereInput> | null
  OR?: Enumerable<SpaceMetaScalarWhereInput> | null
  NOT?: Enumerable<SpaceMetaScalarWhereInput> | null
}
...
export type SpaceMetaUpdateManyWithoutSpaceInput = {
  create?: Enumerable<SpaceMetaCreateWithoutSpaceInput> | null
  connect?: Enumerable<SpaceMetaWhereUniqueInput> | null
  set?: Enumerable<SpaceMetaWhereUniqueInput> | null
  disconnect?: Enumerable<SpaceMetaWhereUniqueInput> | null
  delete?: Enumerable<SpaceMetaWhereUniqueInput> | null
  update?: Enumerable<SpaceMetaUpdateWithWhereUniqueWithoutSpaceInput> | null
  updateMany?: Enumerable<SpaceMetaUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<SpaceMetaScalarWhereInput> | null
  upsert?: Enumerable<SpaceMetaUpsertWithWhereUniqueWithoutSpaceInput> | null
}
...
export type CategoryUpdateManyWithoutSpacesInput = {
  ...
  update?: Enumerable<CategoryUpdateWithWhereUniqueWithoutSpacesInput> | null
  updateMany?: Enumerable<CategoryUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<CategoryScalarWhereInput> | null
  upsert?: Enumerable<CategoryUpsertWithWhereUniqueWithoutSpacesInput> | null
}
...
export type SpaceUpdateWithoutNotificationDataInput = {
  ...
  createdAt?: Date | string | null
  updatedAt?: Date | string | null
  user?: UserUpdateOneRequiredWithoutSpacesInput | null
  members?: UserUpdateManyWithoutMemberOfInput | null
  itemMeta?: SpaceMetaUpdateManyWithoutSpaceInput | null
  posts?: PostUpdateManyWithoutSpaceInput | null
  categories?: CategoryUpdateManyWithoutSpacesInput | null
}
...
export type SpaceUpdateOneRequiredWithoutNotificationInput = {
  create?: SpaceCreateWithoutNotificationInput | null
  connect?: SpaceWhereUniqueInput | null
  update?: SpaceUpdateWithoutNotificationDataInput | null
  upsert?: SpaceUpsertWithoutNotificationInput | null
}
...
export type UserUpdateWithoutThreadsDataInput = {
  ...
  spaces?: SpaceUpdateManyWithoutUserInput | null
  memberOf?: SpaceUpdateManyWithoutMembersInput | null
  ...
  sentNotifications?: NotificationUpdateManyWithoutSenderInput | null
  recievedNotifications?: NotificationUpdateManyWithoutReceiverInput | null
  Message?: MessageUpdateManyWithoutUserInput | null
}
...
export type NotificationUpdateWithoutReceiverDataInput = {
  ...
  space?: SpaceUpdateOneRequiredWithoutNotificationInput | null
  post?: PostUpdateOneRequiredWithoutNotificationInput | null
...
export type NotificationUpdateManyWithoutReceiverInput = {
  ...
  update?: Enumerable<NotificationUpdateWithWhereUniqueWithoutReceiverInput> | null
  ...
  upsert?: Enumerable<NotificationUpsertWithWhereUniqueWithoutReceiverInput> | null
}
...
export type PostUpdateWithoutNotificationDataInput = {
  ...
  space?: SpaceUpdateOneRequiredWithoutPostsInput | null
...
export type PostUpdateOneRequiredWithoutNotificationInput = {
  create?: PostCreateWithoutNotificationInput | null
  connect?: PostWhereUniqueInput | null
  update?: PostUpdateWithoutNotificationDataInput | null
  upsert?: PostUpsertWithoutNotificationInput | null
}
...
export type NotificationUpdateManyWithoutSenderInput = {
  ...
  disconnect?: Enumerable<NotificationWhereUniqueInput> | null
  delete?: Enumerable<NotificationWhereUniqueInput> | null
  update?: Enumerable<NotificationUpdateWithWhereUniqueWithoutSenderInput> | null
  updateMany?: Enumerable<NotificationUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<NotificationScalarWhereInput> | null
  upsert?: Enumerable<NotificationUpsertWithWhereUniqueWithoutSenderInput> | null
}
...
export type MessageUpdateWithoutThreadDataInput = {
  ...
  createdAt?: Date | string | null
  updatedAt?: Date | string | null
  user?: UserUpdateOneRequiredWithoutMessageInput | null
  itemMeta?: MessageMetaUpdateManyWithoutMessageInput | null
}
...
export type PostUpdateWithoutQuestionsDataInput = {
  ...
  reviews?: ReviewUpdateManyWithoutPostInput | null
  annotations?: AnnotationUpdateManyWithoutPostInput | null
  Notification?: NotificationUpdateManyWithoutPostInput | null
}
...
export type NotificationUpdateManyWithoutSpaceInput = {
  ...
  disconnect?: Enumerable<NotificationWhereUniqueInput> | null
  delete?: Enumerable<NotificationWhereUniqueInput> | null
  update?: Enumerable<NotificationUpdateWithWhereUniqueWithoutSpaceInput> | null
  updateMany?: Enumerable<NotificationUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<NotificationScalarWhereInput> | null
  upsert?: Enumerable<NotificationUpsertWithWhereUniqueWithoutSpaceInput> | null
}
...
export type SpaceUpdateWithoutUserDataInput = {
  ...
  posts?: PostUpdateManyWithoutSpaceInput | null
  categories?: CategoryUpdateManyWithoutSpacesInput | null
  Notification?: NotificationUpdateManyWithoutSpaceInput | null
}
...
export type SpaceScalarWhereInput = {
  ...
  updatedAt?: Date | string | DateTimeFilter | null
  Notification?: NotificationFilter | null
  AND?: Enumerable<SpaceScalarWhereInput> | null
  OR?: Enumerable<SpaceScalarWhereInput> | null
  NOT?: Enumerable<SpaceScalarWhereInput> | null
}
...
export type SpaceUpdateManyWithoutUserInput = {
  create?: Enumerable<SpaceCreateWithoutUserInput> | null
  connect?: Enumerable<SpaceWhereUniqueInput> | null
  set?: Enumerable<SpaceWhereUniqueInput> | null
  disconnect?: Enumerable<SpaceWhereUniqueInput> | null
  delete?: Enumerable<SpaceWhereUniqueInput> | null
  update?: Enumerable<SpaceUpdateWithWhereUniqueWithoutUserInput> | null
  updateMany?: Enumerable<SpaceUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<SpaceScalarWhereInput> | null
  upsert?: Enumerable<SpaceUpsertWithWhereUniqueWithoutUserInput> | null
}
...
export type PostUpdateManyWithoutSpaceInput = {
  ...
  update?: Enumerable<PostUpdateWithWhereUniqueWithoutSpaceInput> | null
  updateMany?: Enumerable<PostUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<PostScalarWhereInput> | null
  upsert?: Enumerable<PostUpsertWithWhereUniqueWithoutSpaceInput> | null
}
...
export type SpaceUpdateManyWithoutMembersInput = {
  ...
  disconnect?: Enumerable<SpaceWhereUniqueInput> | null
  delete?: Enumerable<SpaceWhereUniqueInput> | null
  update?: Enumerable<SpaceUpdateWithWhereUniqueWithoutMembersInput> | null
  updateMany?: Enumerable<SpaceUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<SpaceScalarWhereInput> | null
  upsert?: Enumerable<SpaceUpsertWithWhereUniqueWithoutMembersInput> | null
}
...
export type UserUpdateOneRequiredWithoutSpacesInput = {
  create?: UserCreateWithoutSpacesInput | null
  connect?: UserWhereUniqueInput | null
  update?: UserUpdateWithoutSpacesDataInput | null
  upsert?: UserUpsertWithoutSpacesInput | null
}
...
export type SpaceUpdateOneRequiredWithoutPostsInput = {
  create?: SpaceCreateWithoutPostsInput | null
  connect?: SpaceWhereUniqueInput | null
  update?: SpaceUpdateWithoutPostsDataInput | null
  upsert?: SpaceUpsertWithoutPostsInput | null
}
...
export type SpaceCreateWithoutItemMetaInput = {
  id?: string | null
  itemType: string
  itemStatus: string
  itemUrlSegment: string
...
export type SpaceCreateOneWithoutItemMetaInput = {
  create?: SpaceCreateWithoutItemMetaInput | null
  connect?: SpaceWhereUniqueInput | null
}

export type SpaceMetaCreateInput = {
  id?: string | null
  metaType: string
  metaName: string
  metaValue: string
  ...
  createdAt?: Date | string | null
  updatedAt?: Date | string | null
  space: SpaceCreateOneWithoutItemMetaInput
}

export type SpaceUpdateWithoutItemMetaDataInput = {
  id?: string | null
  itemType?: string | null
  itemStatus?: string | null
  itemUrlSegment?: string | null
...
export type SpaceUpsertWithoutItemMetaInput = {
  update: SpaceUpdateWithoutItemMetaDataInput
  create: SpaceCreateWithoutItemMetaInput
}

export type SpaceUpdateOneRequiredWithoutItemMetaInput = {
  create?: SpaceCreateWithoutItemMetaInput | null
  connect?: SpaceWhereUniqueInput | null
  update?: SpaceUpdateWithoutItemMetaDataInput | null
  upsert?: SpaceUpsertWithoutItemMetaInput | null
}

export type SpaceMetaUpdateInput = {
  id?: string | null
  metaType?: string | null
  metaName?: string | null
  metaValue?: string | null
  ...
  createdAt?: Date | string | null
  updatedAt?: Date | string | null
  space?: SpaceUpdateOneRequiredWithoutItemMetaInput | null
}

export type SpaceMetaUpdateManyMutationInput = {
  id?: string | null
  metaType?: string | null
  metaName?: string | null
  metaValue?: string | null
...
export type SpaceCreateManyWithoutCategoriesInput = {
  create?: Enumerable<SpaceCreateWithoutCategoriesInput> | null
  connect?: Enumerable<SpaceWhereUniqueInput> | null
}
...
export type CategoryCreateInput = {
  ...
  createdAt?: Date | string | null
  updatedAt?: Date | string | null
  spaces?: SpaceCreateManyWithoutCategoriesInput | null
}
...
export type SpaceUpdateManyWithoutCategoriesInput = {
  ...
  disconnect?: Enumerable<SpaceWhereUniqueInput> | null
  delete?: Enumerable<SpaceWhereUniqueInput> | null
  update?: Enumerable<SpaceUpdateWithWhereUniqueWithoutCategoriesInput> | null
  updateMany?: Enumerable<SpaceUpdateManyWithWhereNestedInput> | null
  deleteMany?: Enumerable<SpaceScalarWhereInput> | null
  upsert?: Enumerable<SpaceUpsertWithWhereUniqueWithoutCategoriesInput> | null
}
...
export type CategoryUpdateInput = {
  ...
  createdAt?: Date | string | null
  updatedAt?: Date | string | null
  spaces?: SpaceUpdateManyWithoutCategoriesInput | null
}
...
export type SpaceFilter = {
  every?: SpaceWhereInput | null
  some?: SpaceWhereInput | null
  none?: SpaceWhereInput | null
}
...
export type SpaceMetaFilter = {
  every?: SpaceMetaWhereInput | null
  some?: SpaceMetaWhereInput | null
  none?: SpaceMetaWhereInput | null
}
...
export type NotificationOrderByInput = {
  ...
  itemContent?: OrderByArg | null
  itemDeleted?: OrderByArg | null
  senderId?: OrderByArg | null
  receiverId?: OrderByArg | null
  spaceId?: OrderByArg | null
...
export type NotificationMetaOrderByInput = {
  id?: OrderByArg | null
  notificationId?: OrderByArg | null
  metaType?: OrderByArg | null
  metaName?: OrderByArg | null
  metaValue?: OrderByArg | null
  metaDeleted?: OrderByArg | null
