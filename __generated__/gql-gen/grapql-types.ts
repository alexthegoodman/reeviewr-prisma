...
export type PodCreateInput = {
  ...
  itemType: Scalars['String'],
  itemUrlSegment: Scalars['String'],
  podMeta?: Maybe<PodMetaCreateOneWithoutPodMetaInput>,
...
export type PodMetaCreateOneWithoutPodMetaInput = {
  connect?: Maybe<PodMetaWhereUniqueInput>,
  create?: Maybe<PodMetaCreateWithoutPodInput>,
};
...
export type UserCreateOneWithoutUserInput = {
  ...
  create?: Maybe<UserCreateWithoutPodInput>,
};
...
export type UserCreateWithoutPodInput = {
  annotations?: Maybe<AnnotationCreateManyWithoutAnnotationsInput>,
  confirmHash: Scalars['String'],
  createdAt?: Maybe<Scalars['DateTime']>,
  favorites?: Maybe<FavoriteCreateManyWithoutFavoritesInput>,
...
export type AllCategoriesQuery = ({ __typename?: 'Query' } & { findManyCategory: Maybe<Array<({ __typename?: 'Category' } & Pick<Category, 'id' | 'itemName'>)>> });

export type UserFragmentFragment = ({ __typename?: 'User' } & Pick<User, 'id'>);
...
export type FindUserQuery = ({ __typename?: 'Query' } & { findOneUser: Maybe<({ __typename?: 'User' } & UserFragmentFragment)> });
